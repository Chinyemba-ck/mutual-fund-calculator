...
// Per project spec: Use S&P 500 as the benchmark market index.
// Beta is calculated using 12 months of monthly return data (1 year rolling window).
// Spec reference: 2026 Engineering ELS Technical Challenge

// Expected return rate is calculated from last year's actual mutual fund price data
// (Jan 1 – Dec 31 of the previous full calendar year, using adjusted closing prices).
